...
export class Models1614110226475 implements MigrationInterface {
    name = 'Models1614110226475'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `user` (`uuid` varchar(36) NOT NULL, `username` varchar(40) NOT NULL, `passwordHash` varchar(255) NOT NULL, `firstName` varchar(255) NOT NULL, `middleName` varchar(255) NULL, `lastName` varchar(255) NOT NULL, `suffix` varchar(255) NULL, `prefix` varchar(255) NULL, `admin` tinyint NOT NULL DEFAULT 0, `created` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `deleted` datetime(6) NULL, UNIQUE INDEX `IDX_78a916df40e02a9deb1c4b75ed` (`username`), PRIMARY KEY (`uuid`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `room` (`uuid` varchar(36) NOT NULL, `created` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `deleted` datetime(6) NULL, `roomTypeUuid` varchar(36) NULL, UNIQUE INDEX `REL_48b2e513d58d8a8d6a404988b3` (`roomTypeUuid`), PRIMARY KEY (`uuid`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `reservation` (`uuid` varchar(36) NOT NULL, `startDate` datetime NOT NULL, `endDate` datetime NOT NULL, `adminCreate` tinyint NOT NULL DEFAULT 0, `created` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `deleted` datetime(6) NULL, `assignedRoomUuid` varchar(36) NULL, `createdByUuid` varchar(36) NULL, PRIMARY KEY (`uuid`)) ENGINE=InnoDB");
