    ...
    <div>
        ...
        <form id="newReservation" class="justify-content-center" @submit.prevent="this.processForm">
            ...
            <div class="name">
                ...
                <br>
                <label v-if="!!this.uuid" id='user' name='user'>{{this.firstName + ' ' + this.lastName}}</label>
                <button v-else class="btn btn btn-danger">
                ...
                <table v-else id="openRooms" name="openRooms" class="table mt-5">
                    ...
                    <tbody>
                        <tr v-for="(room, i) in this.openRooms" :key="i">
                            ...
                            <td><input type="radio" name="assignedRoom" id="assignedRoom" v-model="assignedRoom" :value="room.room_uuid"/></td>
                        </tr>
            ...
            <br>
            <button class="btn btn btn-danger" id="getrooms" @click.prevent="this.getRooms">Get Open Rooms</button>

            <!-- Special Requests -->
            <br />
            <label for="specialRequests" class="requests">
                Special Requests:
            </label>
            <br />
            ...
            <div class="container-fluid">
                <button class="btn btn btn-danger" type="submit">Submit
                </button>
...
export default {
  ...
  methods: {
      processForm: function() {
          ...
          axios.post('http://localhost:4000/newReservation', data)
      ...
      getRooms: function() {
          ...
          data.append('startDate', this.startDate);
          data.append('endDate', this.endDate);
          axios.post('http://localhost:4000/getOpenRooms', data)
